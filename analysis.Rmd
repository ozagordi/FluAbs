...
```{r smooth_ic, echo=FALSE, warning=FALSE}
plot_cv_smoothed(ic_data, "H1_brisbane_log", "Non vaccinated")
plot_cv_smoothed(ic_data, "H1_brisbane_log", "Vaccinated")

plot_cv_smoothed(ic_data, "H2_log", "Non vaccinated")
plot_cv_smoothed(ic_data, "H2_log", "Vaccinated")
```
